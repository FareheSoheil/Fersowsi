...
import PublisherOrderSideFilter from '../PublisherOrderSideFilter';
import { OPCODES } from '../../../../constants/constantData';
import { SERVER } from '../../../../constants';
import { fetchWithTimeOut } from '../../../../fetchWithTimeout';
import s from './PublisherOrderMain.css';

class PublisherOrderMain extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: true,
...
export default withStyles(s)(PublisherOrderMain);
