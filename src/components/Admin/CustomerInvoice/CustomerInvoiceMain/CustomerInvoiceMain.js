...
import CustomerInvoiceSideFilter from '../CustomerInvoiceSideFilter';
import { OPCODES } from '../../../../constants/constantData';
import { fetchWithTimeOut } from '../../../../fetchWithTimeout';
import { SERVER } from '../../../../constants';
import s from './CustomerInvoiceMain.css';

class CustomerInvoiceMain extends React.Component {
  constructor(props) {
    super(props);
    this.props = {
...
export default withStyles(s)(CustomerInvoiceMain);
