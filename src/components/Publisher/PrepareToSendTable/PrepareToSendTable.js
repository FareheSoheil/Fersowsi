...
import s from './PrepareToSendTable.css';
import zeroTrimmer from '../../../zeroTrimmer';
import { PRODUCT_STATUS } from '../../../constants/constantData';

class PrepareToSendTable extends React.Component {
  static propTypes = {
  ...
  render() {
    const tableHeaders = (
      <tr>
        ...
        <th className="border-0">Publication</th>
        <th className="border-0">Subscriber</th>
        <th className="border-0">Copy</th>
        <th className="border-0">Start Date</th>
        <th className="border-0">End Date</th>
        <th className="border-0">Publisher Order No.</th>
      </tr>
    );
    let records = '';
...
export default withStyles(s)(PrepareToSendTable);
