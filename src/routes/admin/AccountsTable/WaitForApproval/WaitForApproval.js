...
import s from './WaitForApproval.css';
...
class WaitForApproval extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <div className="row">
          {this.state.isLoading ? (
            ...
            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
              <div className="card">
                <h5 className="card-header">Wait For Approval</h5>
...
export default withStyles(s)(WaitForApproval);
