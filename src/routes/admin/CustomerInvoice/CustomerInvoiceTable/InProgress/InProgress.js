...
class InProgress extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      customerOrderSearchFilter: {
        ...
        status: CUSTOMER_ORDER_STATUS.InProgress,
        userOrderNo: '',
        currency: '',
        deliveryAddress: '',
  ...
  fetchCustomerInvoices() {
    ...
    const credentials = {
      searchBy: { status: CUSTOMER_ORDER_STATUS.InProgress },
  ...
  fetchAllInfo() {
    const url = `${SERVER}/getAllAuxInfoForAllCustomerInvoices`;
    this.setState({
      isLoading: true,
    });
        ...
        <div>
          ...
          <div className="row">
            <div className="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12">
              <div className="card">
                <h4 className="card-header">In Progress Customer Orders</h4>
                  ...
                  <div className="container-fluid">
                    ...
                    <div className="row">
                      <div className="col-xl-12">
                        <button
                          onClick={this.addCustomerInvoice}
...
export default withStyles(s)(InProgress);
