...
class Delayed extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      customerOrderSearchFilter: {
        ...
        status: CUSTOMER_ORDER_STATUS.Delayed,
        userOrderNo: '',
        currency: '',
        deliveryAddress: '',
  ...
  fetchCustomerInvoices() {
    ...
    const credentials = {
      searchBy: { status: CUSTOMER_ORDER_STATUS.Delayed },
        ...
        <div>
          <div className="row">
            <div className="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12">
              <div className="card">
                <h4 className="card-header">Delayed Customer Orders</h4>
...
export default withStyles(s)(Delayed);
