...
class ClaimsTable extends React.Component {
  ...
  onChangeInput(event) {
    ...
    searchFilter[state] = event.target.value;
    this.setState({ searchFilter, searchClear: false });
                              ...
                              <div className="col-xl-12 col-lg-8 col-md-8 col-sm-8 col-12">
                                ...
                                <label class="custom-color-theme custom-control custom-radio custom-control-inline">
                                  <input
                                    ...
                                    checked={
                                      this.state.searchFilter.claimStatus ===
                                      ClaimStats.closed
                                    }
                                  />
                                  ...
                                  <div className="row">
                                    <div class="col-md-2 col-sm-4 form-group">
                                      <input
                                        ...
                                        value={this.state.searchFilter.senderFN}
                                        class="form-control"
                                        onChange={this.onChangeInput}
                                      />
                                    </div>
                                    <div class="col-md-2 col-sm-4 form-group">
                                      <input
                                        ...
                                        value={this.state.searchFilter.senderLN}
                                        class="form-control"
                                        onChange={this.onChangeInput}
                                      />
                                    </div>
                                    <div className="col-md-3 col-sm-4 form-group">
                                      <div class="form-group">
                                        <input
                                          ...
                                          placeholder="Email"
                                          value={
                                            this.state.searchFilter.senderEmail
                                          }
                                          class="form-control"
                                          onChange={this.onChangeInput}
                                        />{' '}
                                    ...
                                    <div class="col-md-2 col-sm-4 form-group">
                                      <input
                                        ...
                                        value={this.state.searchFilter.senderUN}
                                        class="form-control"
                                        onChange={this.onChangeInput}
                                      />
                                    </div>
                                  ...
                                  <div className="row">
                                    <div class="col-md-2 col-sm-4 form-group">
                                      <input
                                        ...
                                        placeholder="First Name"
                                        value={
                                          this.state.searchFilter.recieverFN
                                        }
                                        class="form-control"
                                        onChange={this.onChangeInput}
                                      />
                                    ...
                                    <div class="col-md-2 col-sm-4 form-group">
                                      <input
                                        ...
                                        placeholder="Last Name"
                                        value={
                                          this.state.searchFilter.recieverLN
                                        }
                                        class="form-control"
                                        onChange={this.onChangeInput}
                                      />
                                    ...
                                    <div class="col-md-2 col-sm-4 form-group">
                                      <input
                                        ...
                                        placeholder="User Name"
                                        value={
                                          this.state.searchFilter.recieverUN
                                        }
                                        class="form-control"
                                        onChange={this.onChangeInput}
                                      />
