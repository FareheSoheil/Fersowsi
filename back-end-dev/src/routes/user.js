...
import searchInAccounts from '../controllers/user/searchInAccounts';
import getUserDetail from '../controllers/user/getUserDetail';
import deleteUser from '../controllers/user/deleteUser'
import setUserDetail from '../controllers/user/setUserDetail'
...
const app = express();
app.post('/searchInAccounts', searchInAccounts);
app.get('/getUserDetail/:userId', getUserDetail);
app.get('/deleteUser/:userId', deleteUser);
app.post('/setUserDetail', setUserDetail);
app.post('/getUsers',getUser);
app.post('/getAllUsers',getAllUser);
