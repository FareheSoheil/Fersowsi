...
const addProduct = async (req, res) => {
  ...
  if (req.user) {
    ...
    [err] = await to(
      Product.create(
        {
          productTypeId : newProductTypeIdSanitized,
          singleProductTypeId : newSingleProductTypeIdSanitized,
          ageGroupId : newAgeGroupIdSanitized,
          publishPeriodId : newPublishPeriodIdSanitized,
          publisherId : newPublisherIdSanitized,
          languageId : newLanguageIdSanitized,
          price : newPriceSanitized,
          discount : newDiscountSanitized,
          tax : newTaxSanitized,
          issn : newIssnSanitized,
          dewey : newDeweySanitized,
          asb : newAsbSanitized,
          englishTitle : newEnglishTitleSanitized,
          englishDesc : newEnglishDescSanitized,
          weight : newWeightSanitized,
          coverImage : newCoverImageSanitized,
        }
      )
    );
    if (err) {
