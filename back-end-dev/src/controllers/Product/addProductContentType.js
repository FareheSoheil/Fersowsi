...
const addProductContentType = async (req, res) => {
  const { 
      newName,
    } = req.body;
  ...
  if (req.user) {
    ...
    res.status(200).json({message: 'product content type is inserted'});
    return;
  }
  else {
...
export default addProductContentType;
