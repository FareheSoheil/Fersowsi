...
const addSingleProductType = async (req, res) => {
  const { 
      newName,
    } = req.body;
  ...
  if (req.user) {
    ...
    res.status(200).json({message: 'single Product type is inserted'});
    return;
  }
  else {
...
export default addSingleProductType;
